...
class MyApp  {
    ...
    init() {
        ...
        this.initCameras();
        this.setActiveCamera('Perspective Left')
    ...
    initCameras() {
        ...
        perspective1.position.set(8,10,3)
        this.cameras['Perspective Right'] = perspective1


        const perspective2 = new THREE.PerspectiveCamera(75, aspect, 0.1, 1000)
        perspective2.position.set(-8, 10, 3);
        this.cameras['Perspective Left'] = perspective2
        ...
        orthoLeft.position.set(-this.frustumSize /4,1,0);
        ...
        orthoFront.position.set(0,1, this.frustumSize /4) 
        ...
        orthoRight.position.set(this.frustumSize /4,1,0) 
        ...
        orthoBack.position.set(0,1, - this.frustumSize /4) 
